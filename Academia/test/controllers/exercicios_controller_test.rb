...
class ExerciciosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exercicio" do
    assert_difference('Exercicio.count') do
      post exercicios_url, params: { exercicio: { modalidade: @exercicio.modalidade, valor: @exercicio.valor } }
    end
  ...
  test "should update exercicio" do
    patch exercicio_url(@exercicio), params: { exercicio: { modalidade: @exercicio.modalidade, valor: @exercicio.valor } }
